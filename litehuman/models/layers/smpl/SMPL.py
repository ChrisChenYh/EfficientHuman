...
from .lbs import lbs, hybrik, rotmat_to_quat, quat_to_rotmat, shapeik
...
class SMPL_layer(nn.Module):
    ...
    def shapeik(self, vertices):
        betas = shapeik(vertices=vertices, t_template=self.v_template, shapedirs=self.shapedirs)
        return betas
