...
parser = argparse.ArgumentParser(description='LiteHuman Training')

"----------------------------- Experiment options -----------------------------"
parser.add_argument('--cfg',
                    help='experiment configure file name',
                    required=False,
                    default='configs/vm_hrnet.yaml',
                    type=str)
...
# parser.add_argument('--dist-url', default='tcp://192.168.1.101:11111', type=str,
...
"----------------------------- Log options -----------------------------"
parser.add_argument('--log', default=True, dest='log')
parser.add_argument('--board', default=False, dest='board',
                    help='Logging with tensorboard', action='store_true')
parser.add_argument('--wandb', default=False, dest='wandb',
                    help='Logging with wandb', action='store_true')
parser.add_argument('--debug', default=False, dest='debug',
                    help='Visualization debug', action='store_true')
parser.add_argument('--img_output', default=False, dest='img_output',
                    action='store_true')
